     ...
     <div>
        ...
        <table border="1">
           <tr>
            ...
            <?php
            include("conn.php");
            $sql = "SELECT * FROM user_det order by User_email";
            ...
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr><td>".$row["User_Nm"]."</td><td>".$row["User_email"]."</td><td>".$row["User_contact"]."</td><td>".$row["User_pwd"]."</td><td><a href='user_edit.php?em=$row[User_email]'>E</a></td><td><a href='all_user_del.php?em=$row[User_email]'>D</a></td></tr>";
            }
            } else {
            echo "0 results";
            }

...
<body>
    ...
    <div class="Dashboard">
                ...
                <div class="Privacy">
                       <a href="all_feedbacks.php" style="text-decoration:none; color:white;"><p>All Feedbacks</p></a>
                        <a href="all_user.php" style="text-decoration:none; color:white;"><p>All User</p></a>
                        <a href="all_queries.php" style="text-decoration:none; color:white;"><p>All Queries</p></a>
                </div>
           </div>
           <div class="Navbar">
                    <div class="Arrow">
                    ...
                    <div style="display:inline-block; position:absolute; right:45%; top:25px; color:white;">
                    <?php    
                        if($_SESSION["user_lg"] != "guest")
                        {
                            echo "Welcome <span>".$_SESSION["user_lg"]."</span>";
           ...
           <div>
           <button class="SignUp"><a style="text-decoration:none; color:white" href="signup.php">Sign Up</a></button>
           <button class="Logout"> <a style="text-decoration:none; color:black" href="adminsignout.php">Logout</a></button>
           </div>

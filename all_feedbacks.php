     ...
     <div>
        ...
        <table border="1">
           <tr>
                ...
                <th>Email</th>
                <th>Feedback</th>
                <th>Feedack Delete</th>
           </tr> 
            <?php
            include("conn.php");
            $sql = "SELECT * FROM feedback_form order by Email";
            ...
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr><td>".$row["Name"]."</td><td>".$row["Email"]."</td><td>".$row["Description"]."</td><td><a href='all_feedback_del.php?em=$row[Email]'>D</a></td></tr>";
            }
            } else {
            echo "0 results";
            }

    ...
    <div class="MySongs" style="background-color: transparent;">
        <div class="HeadImg">
            <div class="verified">
                ...
                <p style="font-size:50px;">Justin Bieber</p>
                <p>75,748,290 monthly listeners</p>
            </div>
        </div>
        <div class="SongsTable">
            <table width="100%" cellspacing="15px" >
                ...
                <tr class="songItem">
                    ...
                    <td class="songName">We're in this together</td>
                    <td>6,060,751</td>
                    <td>3:01</td>
                </tr>
            </table>
